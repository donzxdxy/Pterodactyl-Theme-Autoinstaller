...
install_theme() {
  ...
  THEME_URL="https://github.com/donzxdxy/Pterodactyl-Theme-Autoinstaller/raw/main/${THEME_NAME}.zip"
...
# Unduh file tema
wget -O /root/stellar.zip https://github.com/donzxdxy/Pterodactyl-Theme-Autoinstaller/raw/main/stellar.zip
